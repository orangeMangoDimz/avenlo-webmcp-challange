...
export const CLIENT_SIDEBAR_PINNED_STORAGE_KEY = "utrada-client-sidebar-pinned";
...
export const readSidebarPinned = (
  storageKey = CLIENT_SIDEBAR_PINNED_STORAGE_KEY,
  defaultValue = false,
) => {
  try {
...
/**
 * Keep the top-level navigate button as the only sidebar control.
