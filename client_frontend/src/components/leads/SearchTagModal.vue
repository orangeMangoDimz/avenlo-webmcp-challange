      ...
      <div v-if="modelValue" class="tag-modal" @click.self="close">
        <div class="tag-modal-content">
          ...
          <div class="tag-modal-body">
            ...
            <div class="form-group">
              <label for="tagSearch">Search Keywords</label>
              <input
                id="tagSearch"
              ...
              <span class="help-text">
                Enter keywords separated by commas that will trigger this tag
              </span>
            </div>
          </div>
...
const confirm = () => {
  if (!tagName.value || !searchKeywords.value) {
    alert("⚠️ Please enter both tag name and search keywords.");
    return;
  }
