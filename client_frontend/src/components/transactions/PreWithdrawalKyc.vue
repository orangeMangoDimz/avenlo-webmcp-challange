...
.continue-btn {
  border: none;
  border-radius: var(--radius-md);
  background: linear-gradient(135deg, #8b9cff, #a66cff);
  color: #fff;
  padding: 12px 24px;
  font-size: 14px;
  font-weight: 700;
...
.continue-btn:disabled {
  opacity: 0.75;
  cursor: not-allowed;
  background: linear-gradient(135deg, #d6dcff, #cfb9f3);
  box-shadow: none;
}
...
.inline-addr-hdr {
  background: linear-gradient(135deg, #5e72eb 0%, #8c63c9 100%);
  color: #fff;
  padding: 14px 16px;
  display: flex;
  align-items: center;
