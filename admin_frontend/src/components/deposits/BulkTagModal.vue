    ...
    <div :class="['bulk-tag-modal', { show: modelValue }]" @click="close">
      <div class="bulk-tag-modal-content" @click.stop>
        <div class="bulk-tag-modal-header">
          <h3>
            <i class="fas fa-tags"></i> Add Tags to Selected
            {{ titleContent || "Deposits" }}
          </h3>
        ...
        <div class="bulk-tag-modal-body">
          ...
          <div class="form-group">
            ...
            <input
              ...
              type="text"
              v-model="tagName"
              placeholder="Enter tag name (e.g., High Value, Urgent, Priority)"
              @keyup.enter="confirm"
            />
          </div>
          ...
          <div class="bulk-tag-preview">
            <h4>
              ...
              {{ selectedDeposits.length }} deposit(s)
            </h4>
            <div class="preview-tag">
              <span class="bulk-tag-preview-item">
                <i class="fas fa-tag"></i> {{ tagName || "Tag Preview" }}
              </span>
            </div>
          </div>
          ...
          <div class="selected-deposit-list">
            <h4>
              <i class="fas fa-receipt"></i> Selected Deposits
              <span class="count-badge">{{ selectedDeposits.length }}</span>
            </h4>
