...
const DEFAULT_LOG_SUB_MODULE = getSubModuleKey("page_leads");
...
/**
 * Create preview token for View as client
 * POST /api/leads/:id/preview-token
 */
export const createPreviewToken = (
  leadId,
  logSubModuleKey = DEFAULT_LOG_SUB_MODULE,
) => {
  return api.post(`/leads/${leadId}/preview-token`, { logSubModuleKey });
};
 ...
 */
export const removeTagFromLead = (
  leadId,
  tagId,
  logSubModuleKey = DEFAULT_LOG_SUB_MODULE,
) => {
  return api.delete(`/leads/${leadId}/tags/${tagId}`, {
    params: logSubModuleKey ? { logSubModuleKey } : {},
  });
};
 ...
 */
export const bulkAssignTag = (
  leadIds,
  tagId,
  logSubModuleKey = DEFAULT_LOG_SUB_MODULE,
) => {
  const body = { leadIds, tagId };
  if (logSubModuleKey) {
    body.logSubModuleKey = logSubModuleKey;
  }
  return api.post("/lead-tags/bulk-assign", body);
};
...
/**
 * Reset lead password directly
 */
export const resetPassword = (id, data) => {
  return api.post(`/leads/${id}/reset-password`, data);
};
