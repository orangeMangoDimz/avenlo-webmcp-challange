...
export const OPERATION_LOG_PAGES = {
  ...
  [pageKey("page_points_mall_settings")]: {
  ...
  [pageKey("page_points_mall_products")]: {
  ...
  [pageKey("page_points_mall_redemptions")]: {
    routeName: "points-mall-redemptions",
    path: "/points-mall-redemptions",
    modelKey: "log_points_mall",
    subModuleKey: "pm_redemptions",
    defaultTarget: "client_user",
  },
  [pageKey("page_points_mall_ledger")]: {
    routeName: "points-mall-ledger",
    path: "/points-mall-ledger",
    modelKey: "log_points_mall",
    subModuleKey: "pm_ledger",
    defaultTarget: "client_user",
  },
  [pageKey("page_points_mall_categories")]: {
    routeName: "points-mall-categories",
    path: "/points-mall-categories",
    modelKey: "log_points_mall",
